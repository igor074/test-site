...
{
    public partial class PanelOneVariant : UserControl, IQuestionLib.IQuestionData
    {
        public PanelOneVariant()
        {
            InitializeComponent();
        }
        ...
        public void SetData(List<Otvety> data)
        {
            ...
            OnChangedProperty(IQuestionLib.TypeQuestion.OneVariant);
        }
